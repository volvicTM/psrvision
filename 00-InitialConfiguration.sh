...
sed -i~ -e "s/USERNAME/${uname}/g" 03-DockerSetup.sh
...
sed -i~ -e "s/USERURL/${uurl}/g" 03-DockerSetup.sh
...
sed -i~ -e "s/USEREMAIL/${uemail}/g" 03-DockerSetup.sh
...
sed -i~ -e "s/USERBASICAUTH/${unginx}/g" 03-DockerSetup.sh
